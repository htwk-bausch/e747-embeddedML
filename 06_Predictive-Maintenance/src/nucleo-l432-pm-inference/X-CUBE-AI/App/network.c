...
#define AI_NETWORK_MODEL_SIGNATURE     "0xeabecd76701a99655170ca4e291950d8"
...
#define AI_TOOLS_DATE_TIME   "2025-06-23T20:03:21+0200"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 19100, 1, 1),
    19100, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 640, 1, 1),
    640, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 16384);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 16384);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 16512);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 16512);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 18560);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 18560);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 18624);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 18624);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 19072);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 19072);
    return true;
  }
