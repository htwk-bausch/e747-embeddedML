...
int main(void)
{
  ...
  while (1)
  {
	...
	if (dataRdy) {
	  ...
	  // convert acc values to mg and print values
	  printf("%d,%d,%d,", (int16_t)(acc_axes.x * LSM6DSOX_ACC_SENSITIVITY_FS_4G),
			              (int16_t)(acc_axes.y * LSM6DSOX_ACC_SENSITIVITY_FS_4G),
						  (int16_t)(acc_axes.z * LSM6DSOX_ACC_SENSITIVITY_FS_4G));

	  // convert gyro values to degrees/sec
	  printf("%d,%d,%d\r\n", (int16_t)(gyro_axes.x * LSM6DSOX_GYRO_SENSITIVITY_FS_2000DPS),
			                 (int16_t)(gyro_axes.y * LSM6DSOX_GYRO_SENSITIVITY_FS_2000DPS),
							 (int16_t)(gyro_axes.z * LSM6DSOX_GYRO_SENSITIVITY_FS_2000DPS));
