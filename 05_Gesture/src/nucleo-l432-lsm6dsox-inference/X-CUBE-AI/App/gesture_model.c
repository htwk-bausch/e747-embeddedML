...
#define AI_GESTURE_MODEL_MODEL_SIGNATURE     "0xed229792c5c9468e53770c24f491dc34"
...
#define AI_TOOLS_DATE_TIME   "2025-05-15T12:18:37+0200"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 624, 50, 1, 1), AI_STRIDE_INIT(4, 4, 2496, 124800, 124800),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 15, 2, 1, 1), AI_STRIDE_INIT(4, 4, 60, 120, 120),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    2696, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_GESTURE_MODEL_IN_NUM, &serving_default_keras_tensor_70_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_GESTURE_MODEL_OUT_NUM, &nl_3_output),
  &gemm_0_layer, 0x284b7c97, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_gesture_model_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_70_output_array.data = AI_PTR(g_gesture_model_activations_map[0] + 0);
    serving_default_keras_tensor_70_output_array.data_start = AI_PTR(g_gesture_model_activations_map[0] + 0);
    gemm_0_output_array.data = AI_PTR(g_gesture_model_activations_map[0] + 2496);
    gemm_0_output_array.data_start = AI_PTR(g_gesture_model_activations_map[0] + 2496);
    nl_0_nl_output_array.data = AI_PTR(g_gesture_model_activations_map[0] + 0);
    nl_0_nl_output_array.data_start = AI_PTR(g_gesture_model_activations_map[0] + 0);
    gemm_1_output_array.data = AI_PTR(g_gesture_model_activations_map[0] + 200);
    gemm_1_output_array.data_start = AI_PTR(g_gesture_model_activations_map[0] + 200);
    nl_1_nl_output_array.data = AI_PTR(g_gesture_model_activations_map[0] + 0);
    nl_1_nl_output_array.data_start = AI_PTR(g_gesture_model_activations_map[0] + 0);
    gemm_2_output_array.data = AI_PTR(g_gesture_model_activations_map[0] + 60);
    gemm_2_output_array.data_start = AI_PTR(g_gesture_model_activations_map[0] + 60);
    nl_3_output_array.data = AI_PTR(g_gesture_model_activations_map[0] + 0);
    nl_3_output_array.data_start = AI_PTR(g_gesture_model_activations_map[0] + 0);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_gesture_model_weights_map, 1, params)) {
    ...
    gemm_0_weights_array.data = AI_PTR(g_gesture_model_weights_map[0] + 0);
    gemm_0_weights_array.data_start = AI_PTR(g_gesture_model_weights_map[0] + 0);
    gemm_0_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_0_bias_array.data = AI_PTR(g_gesture_model_weights_map[0] + 124800);
    gemm_0_bias_array.data_start = AI_PTR(g_gesture_model_weights_map[0] + 124800);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_gesture_model_weights_map[0] + 125000);
    gemm_1_weights_array.data_start = AI_PTR(g_gesture_model_weights_map[0] + 125000);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_gesture_model_weights_map[0] + 128000);
    gemm_1_bias_array.data_start = AI_PTR(g_gesture_model_weights_map[0] + 128000);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_gesture_model_weights_map[0] + 128060);
    gemm_2_weights_array.data_start = AI_PTR(g_gesture_model_weights_map[0] + 128060);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_gesture_model_weights_map[0] + 128180);
    gemm_2_bias_array.data_start = AI_PTR(g_gesture_model_weights_map[0] + 128180);
    return true;
  }
